...
if __name__ == "__main__":
    ...
    while i<len(sys.argv):
        ...
        i+=1
    os.system(f"arm-none-eabi-readelf {files[2]} -r >arm.out")
    os.system(f"gcc fusion.c fusion_relocation.c fusion_section.c fusion_ts.c gestion_*.c elf32.c util.c -o fusion_reloc")
    os.system(f"./fusion_reloc {files[0]} {files[1]} ")
    os.system(f"arm-none-eabi-readelf out.o -r > out_fusion")
    d1=getStructFile("arm.out")
    d2=getStructFile("out_fusion")
